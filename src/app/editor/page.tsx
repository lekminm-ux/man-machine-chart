    ...
    return (
      <div className="flex h-screen items-center justify-center bg-slate-950">
        <div className="flex flex-col items-center gap-4">
          ...
          <span className="text-slate-300 text-sm">Loading Chart Workspace…</span>
        </div>
      </div>
    );
  }
                ...
                <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-blue-955 px-6 py-4 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <button
                      ...
                      className="p-1.5 bg-slate-800 hover:bg-slate-700 border border-slate-600 text-slate-300 hover:text-white rounded transition-colors mr-1 cursor-pointer select-none text-xs"
                    ...
                    <div>
                      ...
                      <p className="text-blue-300 text-[10px] font-medium mt-1">Standard Operation Layout</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="text-slate-450 text-xs font-semibold">Rev. {activeFile.header.revNo}</p>
                    <p className="text-slate-500 text-[10px] mt-0.5">{activeFile.header.issueDate}</p>
                  </div>
                </div>
