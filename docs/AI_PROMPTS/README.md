...
[Phase 4c-2 — Drag & Drop rebalancing](PROMPT_CODEX_PHASE4C2_M5_DRAG_DROP.md) (final piece of Phase 4). Codex reports back to Claude (not the user) for review before any further phase, commit, push, or deploy.
